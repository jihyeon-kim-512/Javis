...
def do_calendar_project():
    ...
    print(template)
    lbl = tkinter.Label(win, text = today + "일정 \n" + item['summary'], borderwidth = 1,bg = "white",font=("맑은 고딕", 10), width=30, height=2, anchor='n', justify='left', wraplength=200)
    ...
    lbl.place(x=181, y=175)    
    lb2.place(x=181, y=250)
    lb3.place(x=181, y=300)
    lb4.place(x=181, y=350)
    link1.place(x=181, y=400)
